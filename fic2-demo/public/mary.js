if (my_super_variable==null){
	alert('No TTS service binded !');
}
...
function fillTypes()
{
    ...
    url = my_super_variable + "/datatypes";
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState==4) {
        	if (xmlHttp.status == 200) {
	            var response = xmlHttp.responseText;
...
function fillAudioFormats()
{
    ...
    url = my_super_variable + "/audioformats";
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState==4) {
        	if (xmlHttp.status == 200) {
	            var response = xmlHttp.responseText;
...
function fillEffects()
{
    ...
    url = my_super_variable + "/audioeffects";
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState==4) {
        	if (xmlHttp.status == 200) {
	            var response = xmlHttp.responseText;
...
{
    var url = my_super_variable+"/process";
    var param = "";
